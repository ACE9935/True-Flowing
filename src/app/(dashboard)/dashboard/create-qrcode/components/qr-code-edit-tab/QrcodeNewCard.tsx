    ...
    return ( 
        <div className="pb-4 flex text-white flex-col items-center border-2 p-2 px-5 rounded-lg bg-primary-blue cursor-pointer transition-all">
            ...
            <div className="flex flex-col gap-3 w-full font-bold">
                ...
                <button onClick={()=>router.push("/dashboard/create-qrcode?type=premium")} className="rounded-full gap-2 flex hover:scale-105 transition-all border-2 border-white hover:shadow-md items-center justify-center bg-black text-white text-primary-blue p-3"><Add/>Dynamic</button>
            </div>
        </div>
     );
}
