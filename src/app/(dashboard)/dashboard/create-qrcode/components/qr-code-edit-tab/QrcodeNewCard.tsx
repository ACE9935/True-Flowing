    ...
    return ( 
        <div className="pb-4 flex text-white flex-col items-center border-2 p-2 px-5 rounded-lg bg-primary-blue cursor-pointer transition-all">
            ...
            <div className="flex flex-col gap-3 w-full font-bold">
                <button onClick={()=>router.push("/dashboard/create-qrcode?type=basic")} className="rounded-full flex gap-2 transition-all items-center bg-slate-400 hover:bg-slate-500 justify-center pr-8 text-white border-2 border-white p-3"><Add/>Basic</button>
